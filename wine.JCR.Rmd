...
wine.final = wine.model %>%
  filter((country == "US" | country == "Italy" | country == "France") | (province == "California" | province == "Washington" | province == "Oregon" | province == "Tuscany") | (variety == "PinotNoir" | variety == "Chardonnay" | variety == "CabernetSauvigno" | variety == "RedBlend" | variety == "SauvignonBlanc"))

view(wine.final)

wine.final$grade = as.numeric(wine.final$grade)

mode_f = glm(grade ~ price + country + province + variety,
             data = wine.final,family = binomial(link="logit"))
summary(mode_f)

model_f=glm(grade~price + wine.model$countryUS + wine.model$countryFrance + wine.model$countryItaly + wine.model$provinceCalifornia +  wine.model$provinceWashington + wine.model$provinceOregon + wine.model$provinceTuscany + wine.model$varietyPinotNoir + wine.model$varietyChardonnay + wine.model$varietyCabernetSauvigno + wine.model$varietyRedBlend + wine.model$varietySauvignonBlanc,data=wine.model,
          family = binomial(link="logit"))
summary(model_f)
```
